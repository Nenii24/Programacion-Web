      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/Index.php" <?php if ($_SERVER['REQUEST_URI'] === '/Index.php') { echo 'aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white"'; } else { echo 'class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"'; } ?>>Home</a>
            <a href="/About.php" <?php if ($_SERVER['REQUEST_URI'] === '/About.php') { echo 'aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white"'; } else { echo 'class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"'; } ?>>About Us</a>
            <a href="/Contact.php" <?php if ($_SERVER['REQUEST_URI'] === '/Contact.php') { echo 'aria-current="page" class="rounded-md bg-gray-950/50 px-3 py-2 text-sm font-medium text-white"'; } else { echo 'class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white"'; } ?>>Contact</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
